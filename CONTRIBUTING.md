...
This project uses [ruff](https://docs.astral.sh/ruff/) for linting. Run `uv run ruff check src/ tests/ scripts/` before submitting a PR. The CI will also check this.
